...
def main(context):
    ...
    if context.req.method in ["GET", "POST"]:
        try:
            if data.get("update") == "leaguesByCountry":
                ...
                try:
                    record = cf.common_get_record(
                        "6766ef78000d7daec880", "leaguesInCountry"
                    )
            ...
            if data.get("update") == "allPublic":
                context.log("Attempting to get allPublic...")
            ...
            if data.get("update") == "getTeamOfLeague":
                context.log("Attempting to get getTeamOfLeague...")
